...
/**
 * @author Yokior
 * @description 基础AiProvider实现类 可兼容OpenAI协议接口
 * @date 2026/2/21 21:09
 */
@Slf4j
public class BaseAiProviderImpl implements AiProvider {
    ...
    public BaseAiProviderImpl(RestTemplate restTemplate, String apiKey, String model, String endpoint, Double temperature, Integer maxTokens, Boolean stream) {
